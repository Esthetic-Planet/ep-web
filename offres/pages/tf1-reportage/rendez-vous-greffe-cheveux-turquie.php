...
<header class="header1">
    <div class="header-wrapper">
        <div class="banner-outer">
            <img src="images/reportage-decouverte2.jpg" alt="" class="banner-img">
...
<section id="procedure-section">
    <div class="container">
        <h1 class="text-center">entretien exclusif avec l'équipe de TF1</h2>
        <div class="row text-center procedure">
            <div class="col-md-4 col-sm-4 col-xs-12 procedure-box">
            	<img src="images/tf1-tv.jpg" alt="" class="img-responsive img-circle" >            	
            </div>
...
<section id="team-section">
    <div class="container">
      <h2 class="text-center">Leurs opérations</h2>
      <div class="row team-row1-animations">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="team-box" style="background-color:#F5F5F5 !important;">
                    <div class="team-img">
                            <img src="images/caroline.png" alt="" class="img-responsive img-circle" width="200" >
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="team-box" style="background-color:#F5F5F5 !important;">
                    <div class="team-img">
                            <img src="images/emmanuel.png" alt="" class="img-responsive" width="200">
                            <div class="team-img-overlay"></div>								
                    </div>
                    <div class="team-text">
                      <h4>Emmanuel</h4>
...
La clinique propose des interventions capillaires en FUE sans cicatrice avec un prix extrêmement avantageux (3500-4000 greffes pour 2450 €). Ce prix comprend l'hôtel et les transferts durant votre séjour. Les opérations sont supervisées par le Dr Ergin Er.</p>
            ...
            <div class="col-sm-7 col-md-6 col-xs-12 pull-right">
                <div class="video-container">
                	<img src="images/clinique-greffe-cheveux-turquie.jpg" alt="" >
                </div>
  ...
  <div class="row text-center">
        <div class="col-md-4 col-sm-4 col-xs-12 autre-procedure-box" style="height: 320px;">
                <span class="procedure-boxin1">
                	<img src="images/fue.jpg" alt="" class="img-responsive img-circle" >
                </span>
        ...
        <div class="col-md-4 col-sm-4 col-xs-12 autre-procedure-box" style="height: 320px;">
                <span class="procedure-boxin2">
                	<img src="images/bht.jpg" alt="" class="img-responsive img-circle" >
                </span>
        ...
        <div class="col-md-4 col-sm-4 col-xs-12 autre-procedure-box" style="height: 320px;">
                <span class="procedure-boxin3">
                	<img src="images/kit-prp.jpg" alt="" class="img-responsive img-circle" >
                </span>
        <h3>Kit PRP</h3>          
    ...
    <div class="container">
      ...
      <div class="row team-row1-animations">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="team-box">
                    <div class="team-img">
                            <img src="images/dr-ergin-er.jpg" alt="" class="img-responsive">
                            <div class="team-img-overlay"></div>
                    </div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="team-box">
                    <div class="team-img">
                            <img src="images/hacer-yuce.jpg" alt="" class="img-responsive">
                            <div class="team-img-overlay"></div>								
                    </div>
                    <div class="team-text">
                      <h4>Hacer Yüce</h4>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="patient-img"> 
                    <span>
                        <img src="images/temoignage.jpg" alt="" class="img-responsive img-circle"> 
                    </span>	
                </div>
            </div>
      ...
      <div class="row text-center" style="margin-top:20px;margin-bottom:20px;">
        	<div class="col-md-4 col-sm-4 col-xs-12" style="margin-bottom:10px;">
                ...
                <a href="https://www.esthetic-planet.com/galerie-photo-greffe-cheveux-2500-fue-istanbul.html">
                	<img alt="Greffe de cheveux" src="images/resultat-1-thumb.jpg"><br>
                </a>
            </div>
        	...
        	<div class="col-md-4 col-sm-4 col-xs-12" style="margin-bottom:10px;">
                ...
                <a href="https://www.esthetic-planet.com/galerie-photo-greffe-cheveux-fue-3000-greffes-ergin-Istanbul-5-mois.html">
                	<img alt="Greffe de cheveux" src="images/resultat-patient-2-thumb.jpg"><br>
              </a>
            </div>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12" style="margin-bottom:10px;">
                ...
                <a href="https://www.esthetic-planet.com/galerie-photo-greffe-cheveux-fue-2100-greffes-ergin-Istanbul.html">
                	<img alt="Greffe de cheveux" src="images/resultat-patient-3-thumb.jpg"><br>
              </a>
        </div>   
...
<footer class="footer-style2">
    <div class="container text-center">
        <div class="row">
            <div class="col-xs-12">
                <a href="https://esthetic-planet.com" class="footer-logo">
                ...
                <p>© Copyright 2018. All Rights Reserved by <a target="_blank" href="https://esthetic-planet.com"> Esthetic-Planet</a>.</p>
            </div>
        </div>
     </div> 
</footer>
