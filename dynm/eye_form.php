...
$mesg="";
if($_REQUEST['mseg']!=""){
	if($_REQUEST['mseg']=="doc1") $mesg="Fichier trop volumineux In "."topographie";
	if($_REQUEST['mseg']=="doc2") $mesg="Fichier trop volumineux In "."Pentacam";
	if($_REQUEST['mseg']=="doc3") $mesg="Fichier trop volumineux In "."Pachymetrie";
	if($_REQUEST['mseg']=="doc4") $mesg="Fichier trop volumineux In "."autres documents que vous souhaitez transmettre au chirurgien 1";
	if($_REQUEST['mseg']=="doc5") $mesg="Fichier trop volumineux In "."autres documents que vous souhaitez transmettre au chirurgien 2";
}
?>
...
<div id="middle_area">
  ...
  <div id="right_part">
    <div id="content_area">
      <div class="login_hea">Correction laser de la vision</div>
      <div class="clear"></div>
            ...
            <div id="form">
              <ul>
                ...
                <li class="field1_form">
                  <input type="checkbox" value="Myopie" <?php if(in_array("Myopie", $getval)) {?> checked="checked" <?php } ?> name="title[]">
                  Myopie <br>
                  <input type="checkbox" value="Presbytie" <?php if(in_array("Presbytie", $getval)) {?> checked="checked" <?php } ?> name="title[]">
                  Presbytie <br>
                  <input type="checkbox" value="astigmatisme" <?php if(in_array("astigmatisme", $getval)) {?> checked="checked" <?php } ?> name="title[]">
                  astigmatisme </li>
              </ul>
              <div class="clear"></div>
              <ul>
              ...
              <div class="clear"></div>
              <ul>
                <li class="field_name_form" style="width:160px;"> topographie </li>
                <li class="field1_form">
              ...
              <div class="clear"></div>
              <ul>
                <li class="field_name_form" style="width:160px;"> Pentacam </li>
                <li class="field1_form">
              ...
              <div class="clear"></div>
              <ul>
                <li class="field_name_form" style="width:160px;"> Pachymetrie </li>
                <li class="field1_form">
              ...
              <div class="clear"></div>
              <ul>
                <li class="field_name_form" style="width:160px;"> autres documents  que vous souhaitez transmettre au chirurgien </li>
                <li class="field1_form">
