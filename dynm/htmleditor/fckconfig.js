...
FCKConfig.ToolbarSets["Default"] = [
	['Source','-','Templates','Cut','Copy','Paste','PasteText','PasteWord','-','Print','SpellCheck','Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat','Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
