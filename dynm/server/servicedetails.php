					...
					<div id="listing_page">
						...
						<div class="listing_box1">
							<div class="listing_content">
								...
								<div class="next1" align="right" style="padding-bottom:10px;"><a href="quote.php?qid=<?php echo $_GET["qid"]; ?>&clid=<?php echo $_GET["cid"] ;?>"><img src="images/send_mail.gif" border="0" /></a></div>
								<div class="clear"></div>
							</div>
						</div>
						<?php 
