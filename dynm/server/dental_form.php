...
if(isset($_POST['submit']) && ($_REQUEST['submit'] == "Submit"))
{
	...
	{
		if($k=="title" || $k=='name' ||  $k=="surname" || $k=="age" ||  $k=="mobile" || $k=="landline" || $k=="city" || $k=="email"  || $k=="do_smoke" )
		{
			$ConArr[$k]=$v;
			$Data[$k]=$v;
		}
	...
	$message_body = '<table cellpadding="0" cellspacing="0" border="0">
		...
		<tr>		<td colspan="2">&nbsp;</td>			</tr>
		<tr>		<td>Surname :	</td><td>'.$_REQUEST["surname"].'</td>			</tr>
		<tr>		<td colspan="2">&nbsp;</td>			</tr>
		<tr>		<td>Age :	</td><td>'.$_REQUEST["age"].'</td>			</tr>
		<tr>		<td colspan="2">&nbsp;</td>			</tr>
		<tr>		<td>Mobile Number :	</td><td>'.$_REQUEST["mobile"].'</td>			</tr>
		<tr>		<td colspan="2">&nbsp;</td>			</tr>
		<tr>		<td>Landline Number :	</td><td>'.$_REQUEST["landline"].'</td>			</tr>
		<tr>		<td colspan="2">&nbsp;</td>			</tr>
		<tr>		<td>City :	</td><td>'.$_REQUEST["city"].'</td>			</tr>
		<tr>		<td colspan="2">&nbsp;</td>			</tr>
		<tr>		<td>Email-ID :	</td><td>'.$_REQUEST["email"].'</td>			</tr>		
		<tr>		<td colspan="2">&nbsp;</td>			</tr>
...
<?php include("header.php"); ?>
	...
	<div id="middle_area">
			...
			<div id="content_area">
				...
				<div id="clinic_page">
					...
					<div id="sea_mid">
						...
						<div id="form">
						<ul>
							<li class="field_name_form">Title :</li>
							<li class="field1_form">
							  <!--<select name="title" class="listmenu" id="chksbox_country" title="Please select the Services" onchange="return onchangeajax(this.value)";>-->
							<select name="title" class="listmenu">
							  	<option value="">Sélectionner...</option>
								<option value="Mr" <?php if($Data_list["title"]=="Mr"){?> selected="selected" <?php } ?>>Mr</option>
								<option value="Mme" <?php if($Data_list["title"]=="Mme"){?> selected="selected" <?php } ?>>Mme</option>
								<option value="Mlle" <?php if($Data_list["title"]=="Mlle"){?> selected="selected" <?php } ?>>Mlle</option>
							</select>
							</li>
						</ul>
						<div class="clear"></div>
						<ul>
							<li class="field_name_form">Nom :*</li>
							<li class="field1_form">
								<div id="clinicdiv">
									<input type="text" value="<?php echo $Data_list["name"]; ?>" name="name" id="chk_name" class="textbox2" title="Veuillez renseigner votre nom">
								</div>
							</li>
						</ul>
						<div class="clear"></div>
						...
						<ul>
							<li class="field_name_form">Prénom :</li>
							<li class="field1_form"><input type="text" value="<?php echo $Data_list["surname"]; ?>" name="surname" class="textbox2"></li>
						</ul>
						<div class="clear"></div>
						<ul>
		...
		"></li>
						...
						<div class="clear"></div>
						<ul>
							<li class="field_name_form">Téléphone portable :*</li>
							<li class="field1_form"><input type="text" value="<?php echo $Data_list["mobile"]; ?>" name="mobile" id="chkphone_mobile"  class="textbox2" title="Veuillez renseigner votre telephone "></li>
						</ul>
						<div class="clear"></div>
						<ul>
							<li class="field_name_form">Téléphone fixe :</li>
						...
						<div class="clear"></div>
						<ul>
							<li class="field_name_form">Votre Email :*</li>
							<li class="field1_form"><input type="text" value="<?php echo $Data_list["email"]; ?>" name="email" id="chkemail_email"  class="textbox2" title="Votre adresse e-mail 1 n'est pas complète ou contient des caractères invalides."></li>
						</ul>
						<div class="clear"></div>
						<!--<ul>
							<li class="field_name_form">Confirmation Email :*</li>
							<li class="field1_form"><input type="text" value="" name="confrmemail" id="chkemail_confrmemail" title="Votre adresse e-mail 1 n'est pas complète ou contient des caractères invalides."  class="textbox2"></li>
						</ul>
						<div class="clear"></div>-->
						<ul>
