			...
			<div id="content_area">
				...
				<div id="clinic_page">
					...
					<div id="sea_mid">
						...
						<ul>
							<li class="field1_form">
								<input type="checkbox" name="hair_frm" id="hair_frm" > <a href="dentalfrm_detail.php?qid=2">Formulaire dentaire</a>
							</li>
							<li class="field_name_form">
								<!--Edit-->
							</li>
						...
						<ul>
							<li class="field1_form">
								<input type="checkbox" name="hair_frm" id="hair_frm" > <a href="plasticsurgeryfrm_detail.php?qid=6">Formulaire chirurgie esthétique</a>
							</li>
							<li class="field_name_form">
								<!--Edit-->
							</li>
						...
						<ul>
							<li class="field1_form">
								<input type="checkbox" name="hair_frm" id="hair_frm" > <a href="eyefrm_detail.php?qid=4">chirurgie des yeux</a>
							</li>
							<li class="field_name_form">
								<!--Edit-->
							</li>
