						...
						<ul>
							...
							<li class="field1">
								<select class="listmenu" name="country" id="country">
									...
									{
									?>
										<option value="<?php echo $countrylist['countries_name']; ?>" <?php if($countrylist['countries_name'] == $country) {?> selected="selected" <?php }?>><?=$countrylist['countries_name']?></option>
								<?php
								}
								?>
								</select>
					...
					<div id="listing_page">
						...
						<div class="listing_box">
							<div class="listing_content">
								...
								<div class="next1" align="right"><a href="quote.php?qid=<?php echo $link; ?>&clid=<?php echo $Data_list[$i]["UserId"] ;?>"><img src="images/send_mail.gif" border="0" /></a></div>
								<?php } ?>
								</div>
								<div class="clear"></div>
							</div>
