...
if(isset($_POST['submit']) && ($_REQUEST['submit'] == "Submit"))
{
	...
	if($intResult)
	{
		...
		if($_FILES['dental_panoramic']['size'] >2000000 || $_FILES['dental_panoramic']['error'])
	{
	
	header("Location: dental_form.php?mseg=panoramic&did=".$_REQUEST['did']."&qid=".$_REQUEST['qid']."&clid=".$_REQUEST['clid']);
	die();
	}
	...
	header("Location: dental_form.php?mseg=photo1&did=".$_REQUEST['did']."&qid=".$_REQUEST['qid']."&clid=".$_REQUEST['clid']);
	die();
	}
				$upload_dir= _UPLOAD_FILE_PATH."mail_attachment/";
	...
	header("Location: dental_form.php?mseg=photo2&did=".$_REQUEST['did']."&qid=".$_REQUEST['qid']."&clid=".$_REQUEST['clid']);
	die();
	}
				$upload_dir= _UPLOAD_FILE_PATH."mail_attachment/";
	...
	header("Location: dental_form.php?mseg=photo3&did=".$_REQUEST['did']."&qid=".$_REQUEST['qid']."&clid=".$_REQUEST['clid']);
	die();
	}
				$upload_dir= _UPLOAD_FILE_PATH."mail_attachment/";
	...
	header("Location: dental_form.php?mseg=photo4&did=".$_REQUEST['did']."&qid=".$_REQUEST['qid']."&clid=".$_REQUEST['clid']);
	die();
	}
				$upload_dir= _UPLOAD_FILE_PATH."mail_attachment/";
	...
	header("Location: dentalfrm_detail.php?msg=thk");
	die();
	}
...
}  else  if(isset($_POST['submit']) && (($_REQUEST['submit'] == "Update")||($_REQUEST['submit'] == "Envoyer")))
{
	...
	die();
		...
		}else {  if($attachmants != "" && $Data_list["dental_panoramic"]!="")	  $attachmants .= "|";
				$attachmants .= $Data_list["dental_panoramic"] ; }
	...
	die();
		...
		}else {  if($attachmants != "" && $Data_list["image1"]!="")	  $attachmants .= "|";
				$attachmants .= $Data_list["image1"] ; }
		if($_FILES['photo2']['name']!="")
		{
	...
	die();
		...
		}else {  if($attachmants != "" && $Data_list["image2"]!="")	  $attachmants .= "|";
				$attachmants .= $Data_list["image2"] ; }
		if($_FILES['photo3']['name']!="")
		{
		if($_FILES['photo3']['size'] >2000000 || $_FILES['photo3']['error'])
	{
	...
	die();
		...
		}else {  if($attachmants != "" && $Data_list["image3"]!="")	  $attachmants .= "|";
				$attachmants .= $Data_list["image3"] ; }
		if($_FILES['photo4']['name']!="")
		{
		if($_FILES['photo4']['size'] >2000000 || $_FILES['photo4']['error'])
	{
	...
	die();
		...
		}else {  if($attachmants != "" && $Data_list["image4"]!="")	  $attachmants .= "|";
				$attachmants .= $Data_list["image4"] ; }
...
if($_REQUEST['mseg']!="")
{
	if($_REQUEST['mseg']=="panoramic") $mesg="Fichier trop volumineux In "."Panoramique dentaire";
	if($_REQUEST['mseg']=="photo1") $mesg="Fichier trop volumineux In "."Photo 1";
	if($_REQUEST['mseg']=="photo2") $mesg="Fichier trop volumineux In "."Photo 2";
	if($_REQUEST['mseg']=="photo3") $mesg="Fichier trop volumineux In "."Photo 3";
	if($_REQUEST['mseg']=="photo4") $mesg="Fichier trop volumineux In "."Photo 4";
}
?>
	...
	<div id="middle_area">
		...
		"></li>
						...
						<ul>
							...
							Décrivez ici les soins dentaires que vous avez déja eu, et ceux que vous souhaitez réaliser :<br />
						...
						<ul>
							...
							<li class="field1_form">
								<input type="file" id="dental_panoramic" name="dental_panoramic"> (2 Mo maximum)
								<?php
						...
						<ul>
							...
							<li class="field1_form">
								<input type="file" id="photo1" name="photo1"> (2 Mo maximum)
								<?php
						...
						<ul>
							...
							<li class="field1_form">
								<input type="file" id="photo2" name="photo2"> (2 Mo maximum)
								<?php
						...
						<ul>
							...
							<li class="field1_form">
								<input type="file" id="photo3" name="photo3"> (2 Mo maximum)
								<?php
						...
						<ul>
							...
							<li class="field1_form">
								<input type="file" id="photo4" name="photo4"> (2 Mo maximum)
								<?php
