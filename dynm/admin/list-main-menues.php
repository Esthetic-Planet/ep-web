...

{
			...
			$arrFaqs_del = $sql->SqlSingleRecord('mos_tblMainMenu',$ConArr_del);
...

		{
			...
			$sql->SqlDelete('mos_tblMainMenu',$cond);	

			

		echo "<body>";

		echo '<form name="frmSu" id="frmSu" method="post" action="'._ADMIN_WWWROOT.'list-main-menues.php">';
          ...
          <tr>
            ...
            <td height="25" valign="top" class="grey_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td><h1>Manage Main Menues </h1></td>
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="0%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td align="center" valign="top"><a href="add-main-menu.php" class="add_del">Add menu </a></td>
                  ...
                  <tr>
					...
					?>
                      ...
                      <tr <?=($i%2==0)? 'class="grey_bg"' : ""?>>
						...
						<a href="add-main-menu.php?mode=edit&mid=<?=$Data[$i]['mid']?>&page=<?=$page?>">

						<img src="images/edit_button.gif" alt="" width="59" height="19" border="0"></a></td>

                        <td width="11%" align="center" class="white_text">

						<a href="javascript: void(0)" onclick="SingleDelete('list-main-menues.php?delid=<?=$Data[$i]['mid']?>&page=<?=$page?>');">
