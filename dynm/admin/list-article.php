...

{
			...
			$arrFaqs_del = $sql->SqlSingleRecord('mos_tblArticle',$ConArr_del);
...

		{
			...
			$sql->SqlDelete('mos_tblArticle',$cond);	
  ...
  <tr>
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		$webPage = $sql->SqlRecords("mos_tblArticle",$cond,$orderby,$offset,$records_per_page);
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="0%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td align="center" valign="top"><a href="add-article.php" class="add_del">Add article </a></td>
                  ...
                  <tr>
					...
					?>
                      ...
                      <tr <?=($i%2==0)? 'class="grey_bg"' : ""?>>
						...
						<a href="add-article.php?mode=edit&mid=<?=$Data[$i]['mid']?>&page=<?=$page?>">

						<img src="images/edit_button.gif" alt="" width="59" height="19" border="0"></a></td>

                        <td width="11%" align="center" class="white_text">

						<a href="javascript: void(0)" onclick="SingleDelete('list-article.php?delid=<?=$Data[$i]['mid']?>&page=<?=$page?>');">
