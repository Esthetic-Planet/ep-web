...
{		
	...
	$intResult = $sql->SqlInsert('mos_tblnews',$ConArr);

	if($intResult)
	{
			$_SESSION["msg"]  = "added";
			header("location:"._ADMIN_WWWROOT."list-news.php");
			die();
	}
	else
	{
...
{		
	...
	$intResult = $sql->SqlUpdate('mos_tblnews',$ConArr,$CondArr);
	$_SESSION["msg"]  = "update";
	header("location:"._ADMIN_WWWROOT."list-news.php");
	die();
}
	...
	if(isset($_REQUEST['ID']) && ($_REQUEST['mode']=='edit'))
	{
		$ID = $_REQUEST['ID'];
		$ConArr = " WHERE ID= '$ID' "; 						
		$arrBrands = $sql->SqlSingleRecord('mos_tblnews',$ConArr);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>    <td valign="top"><?php include_once('include/header.php');?><div id="breadcrumbs"> <a href="home.php">Home</a> &raquo; <a href="add-news.php">Add/Edit News</a></div></td>  </tr>
  <tr>
         ...
         <td height="25" valign="top" class="grey_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
           <td valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">              
            ...
            <tr>
             <td align="right" valign="top" class="normal_text_blue"><sup class="requried_sign">*</sup>News Title:</td>
            ...
            <tr><td height="20" align="right" valign="top" colspan="3">&nbsp;</td></tr>
              ...
              <tr><td height="20" align="right" valign="top" colspan="3">&nbsp;</td>            </tr>
              <tr>
                <td align="right" valign="top" class="normal_text_blue">News Detail:</td>
                <td align="left" valign="top">&nbsp;</td>
                <td align="left" valign="top"></td>
              </tr>
             ...
             <tr>
              ...
              <tr>
				...
				<input type="button" name="cancel"  value="Cancel" class="btn" onClick="location.href='list-news.php?page=<?=$page?>'">				
				</td>
              </tr>
            </table></td>
          </tr>
