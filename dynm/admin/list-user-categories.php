...
if($_REQUEST['delid']!="")
{
	...
	$delete_rec_cond="where UserCategories like '".$cat_id."' or UserCategories like '".$cat_id.",%' or UserCategories like '%,".$cat_id.",%' or UserCategories like '%,".$cat_id."'";
	$del_rec_arr= $sql->SqlSingleRecord('esthp_tblUsers',$delete_rec_cond);
	...
	{
		echo "<body>";
		echo '<form name="frmSu" id="frmSu" method="get" action="'._ADMIN_WWWROOT.'list-user-categories.php">';
		echo '<input type="hidden" name="msg" id="msg" value="clinic_exists">';
		echo '</form>';
		echo '<script type="text/javascript">document.frmSu.submit();</script>';
		echo '</body>';		
		exit;	
	...
	{	
		...
		$cat_rec_arr= $sql->SqlSingleRecord('esthp_tblUserCat',$cat_rec_cond);
		...
		if($cat_count>0)
		{
			...
			$cat_small_image =$cat_data['cat_small_image'];
			$cat_small_image_file=$upload_dir.$cat_small_image ;
			@unlink($cat_small_image_file);
			
			$delete_cond="cat_id='".$cat_id."'";
			//echo "<br/>";
			$sql->SqlDelete('esthp_tblUserCat',$delete_cond);		
...
else if($msg=='clinic_exists')
	$message="<span class=\"loginErrBox\"><span class='alert_icon'></span>".'You can not delete this category because clinics have been added under it.'."</sapn>";
?>
...
<body>
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr><td valign="top"><?php include_once('include/header.php');?><div id="breadcrumbs"> <a href="home.php">Home</a> &raquo; <a href="list-user-categories.php">Manage Clinic Categories</a></div></td></tr>
  <tr>
          ...
          <tr>
            <td height="25" valign="top" class="grey_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td><h1>List Clinic Categories</h1></td>
              </tr>
            </table></td>
          </tr>
  ...
  <?php
		...
		$cat_arr = $sql->SqlRecords("esthp_tblUserCat",$cond,$orderby,$offset,$records_per_page);
               ...
               <tr>
                ...
                <td valign="top"><table width="0%" border="0" cellspacing="0" cellpadding="0">
                 ...
                 <tr>
                   ...
                   <td width="125" align="center" valign="top"><a href="add-user-category.php" class="add_del">Add Clinic Category</a></td>
                      ...
                      <tr class="left_headbg">
                       ...
                       <!-- <td width="10%" align="left" class="white_text">Status</td> -->
						...
						?>
							...
							<td align="center" class="white_text"><a href="add-user-category.php?cat_id=<?=$Data[$i]['cat_id']?>&page=<?=$page?>"><img src="images/edit_button.gif" alt="" width="59" height="19" border="0"></a></td>

							<td  align="center" class="white_text"><a href="javascript: void(0)" onclick="SingleDelete('list-user-categories.php?delid=<?=$Data[$i]['cat_id']?>&page=<?=$page?>');"><img src="images/delete_button.gif" alt="Delete" width="59" height="19" border="0"></a></td>
