...

{
			...
			$ConArr_del = " WHERE mid= '$id_del' "; 

			$arrFaqs_del = $sql->SqlSingleRecord('mos_tblFooterMenu',$ConArr_del);
...

		{
			...
			$sql->SqlDelete('mos_tblFooterMenu',$cond);	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td valign="top"><?php include_once('include/header.php');?><div id="breadcrumbs"> <a href="home.php">Home</a> &raquo; <a href="list-footer-menues.php">List Footer Menus</a></td>
  ...
  <tr>
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="232" valign="top" class="border_left"><?php include_once('include/admin_left.php');?></div></td>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td height="25" valign="top" class="grey_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td><h1>Manage Footer Menues </h1></td>
		  ...
		  <tr>
                ...
                <td valign="top" width="25"><img src="images/spacer.gif" alt="" width="1" height="5"></td>
		...
		$Data = $webPage['Data'];
          ...
          <tr>
			...
			<form method="post" action="" name="frmMenues">
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="0%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td align="center" valign="top"><a href="add-footer-menu.php" class="add_del">Add menu </a></td>
                  ...
                  <tr>
                    ...
                    <td valign="middle" class="left_headbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td width="21%" class="white_text">Menu Name</td> 

						<td width="15%" align="center" class="white_text">Active/Inactive</td>
                  ...
                  <tr>
					...
					?>
                      ...
                      <tr <?=($i%2==0)? 'class="grey_bg"' : ""?>>
                        ...
                        <td width="5%" height="50"><input type="checkbox" name="chk[]" value="<?=$Data[$i]['mid']?>"></td>

                        <td width="21%" class="black_text"><?=$Data[$i]['mName']?></td> 
						...
						<a href="add-footer-menu.php?mode=edit&mid=<?=$Data[$i]['mid']?>&page=<?=$page?>">

						<img src="images/edit_button.gif" alt="" width="59" height="19" border="0"></a></td>

                        <td width="11%" align="center" class="white_text">

						<a href="javascript: void(0)" onclick="SingleDelete('list-footer-menues.php?delid=<?=$Data[$i]['mid']?>&page=<?=$page?>');">
