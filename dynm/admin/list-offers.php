...

{
	...
	$arrFaqs_del = $sql->SqlSingleRecord('mos_tblOffers',$ConArr_del);
...

	{
		...
		$sql->SqlDelete('mos_tblOffers',$cond);	
...
<body>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr><td valign="top"><?php include_once('include/header.php');?><div id="breadcrumbs"> <a href="home.php">Home</a> &raquo; <a href="list-offers.php">List Offers</a></div></td></tr>
  ...
  <?	$records_per_page=30;				
		...
		$offer = $sql->SqlRecords("mos_tblOffers",$cond,$orderby,$offset,$records_per_page);

		$count_total=$offer['TotalCount'];
	  ...
	  ?>
         ...
         <tr>
          ...
          <td valign="top">
		   ...
		   <form method="post" action="" name="frmoffers">
               ...
               <tr>
                ...
                <td valign="top"><table width="0%" border="0" cellspacing="0" cellpadding="0">
                 ...
                 <tr>
                   ...
                   <td width="125" align="center" valign="top"><a href="add-offer.php" class="add_del">Add Offers</a></td>
                  ...
                  <tr>
                    ...
                    <td valign="middle" class="left_headbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td width="48%" class="white_text">offer Name</td>

                        <td width="8%" align="center" class="white_text"> Status</td>

                        <td width="18%" align="center" class="white_text">Last Modified</td>
			...
			<?	if($count>0)

					{
						...
						{	?>
							...
							<td width="4%" height="25"><input type="checkbox" name="chk[]" value="<?=$Data[$i]['id']?>"></td>

							<td width="48%" class="black_text"><? echo $Data[$i]['name']; ?></td>

							<td width="8%" align="center" class="black_text"><?=$Data[$i]['status']?></td>

							<td align="center" class="black_text"><?=date("d/m/Y",strtotime($Data[$i]['modifiedDate']))?>							  <a href="list-pageImages.php?pageid=<?=$Data[$i]['id']?>"></a></td>

							<td width="10%" align="center" class="white_text"><a href="add-offer.php?mode=edit&id=<?=$Data[$i]['id']?>&page=<?=$page?>"><img src="images/edit_button.gif" alt="" width="59" height="19" border="0"></a></td>

							<td width="12%" align="center" class="white_text"><a href="javascript: void(0)" onclick="SingleDelete('list-offers.php?delid=<?=$Data[$i]['id']?>&page=<?=$page?>');"><img src="images/delete_button.gif" alt="Delete" width="59" height="19" border="0"></a></td>
...
<SCRIPT type=text/javascript>
...

	{
...

		{
			...
			if(confirm("Are you sure you want to delete the selected Offer(s)?"))
