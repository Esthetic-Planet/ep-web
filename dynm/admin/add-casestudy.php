...
{		
	...
	$intResult = $sql->SqlInsert('mos_tblcasestudy',$ConArr);
...

	{
			...
			header("location:"._ADMIN_WWWROOT."list-case-study.php");
...
{		
	...
	$intResult = $sql->SqlUpdate('mos_tblcasestudy',$ConArr,$CondArr);
...

	{
		...
		$arrBrands = $sql->SqlSingleRecord('mos_tblcasestudy',$ConArr);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>    <td valign="top"><?php include_once('include/header.php');?><div id="breadcrumbs"> <a href="home.php">Home</a> &raquo; <a href="add-casestudy.php">Add/Edit Case Study</a></div></td>  </tr>
          ...
          <tr>
           ...
           <td valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">              
            ...
            <tr>
             ...
             <td align="right" valign="top" class="normal_text_blue"><sup class="requried_sign">*</sup>Case Study  Title:</td>
...
?>><? echo show_breadcrumbs($DataDest[$i]['id']); ?> </option>
              ...
              <tr>
                ...
                <td align="right" valign="top" class="normal_text_blue">Case Study  Detail:</td>
             ...
             <tr>
              ...
              <tr>
				...
				<input type="button" name="cancel"  value="Cancel" class="btn" onClick="location.href='list-case-study.php?page=<?=$page?>'">				
