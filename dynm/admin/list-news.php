...
if($_REQUEST['delid']!="")
{
	...
	$arrArticles_del = $sql->SqlSingleRecord('mos_tblnews',$ConArr_del);
	...
	{			
		...
		$cond = " ID = '".$delid."'";
		$sql->SqlDelete('mos_tblnews',$cond);				
		...
		header("location:list-news.php?page=$page");
		die();
	}
}
// single Delete end
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="top"><?php include_once('include/header.php');?><div id="breadcrumbs"> <a href="home.php">Home</a> &raquo; <a href="list-news.php">List News</a></div></td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		$webPage = $sql->SqlRecords("mos_tblnews",$cond,$orderby,$offset,$records_per_page);
                  ...
                  <tr>
                    <td valign="top"><table width="0%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td align="center" valign="top"><a href="add-news.php" class="add_del">Add News </a></td>
                      </tr>
                    </table></td>
                  ...
                  <tr>
                    <td valign="middle" class="left_headbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="39%" class="white_text">News Title </td>
                  ...
                  <tr>
					...
					if($count>0){
                      ...
                      <tr <?=($i%2==0)? 'class="grey_bg"' : ""?>>
                        ...
                        <td width="15%" align="center" class="white_text"><a href="add-news.php?mode=edit&ID=<?=$Data[$i]['ID']?>&page=<?=$page?>">	<img src="images/edit_button.gif" alt="" width="59" height="19" border="0"></a></td>
                        <td width="12%" align="center" class="white_text"><a href="javascript: void(0)" onclick="SingleDelete('list-news.php?delid=<?=$Data[$i]['ID']?>&page=<?=$page?>');"><img src="images/delete_button.gif" alt="Delete" width="59" height="19" border="0"></a></td>
                      </tr>
					  <?php 
					  		}
						}
...
<SCRIPT type=text/javascript>
	...
	{	
		if(confirm("Are you sure you want to delete the selected News(s)?"))
		{
