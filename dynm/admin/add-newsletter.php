...
{		
	...
	$intResult = $sql->SqlInsert('mos_tblnewsLetter',$ConArr);
...

	{
			...
			header("location:"._ADMIN_WWWROOT."list-newsletter.php");
...
{		
	...
	$intResult = $sql->SqlUpdate('mos_tblnewsLetter',$ConArr,$CondArr);
...

	{
		...
		$arrBrands = $sql->SqlSingleRecord('mos_tblnewsLetter',$ConArr);
...
/*		var stringfile	=	document.getElementById('imagefile').value;
	...
	stringfile	=	stringfile.split("\.");	

	var 	fileext	=	stringfile[1];
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>    <td valign="top"><?php include_once('include/header.php');?><div id="breadcrumbs"> <a href="home.php">Home</a> &raquo; <a href="add-newsletter.php">Add/Edit News Letter</a></div></td>  </tr>
          ...
          <tr>
           ...
           <td valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">              
            ...
            <tr>
             ...
             <td align="right" valign="top" class="normal_text_blue"><sup class="requried_sign">*</sup>News Letter  Title:</td>
...
?>><? echo show_breadcrumbs($DataDest[$i]['id']); ?> </option>
            ...
            <tr>                <td height="20" colspan="3" align="right" valign="top">&nbsp;</td>                </tr>
              ...
              <tr>
                ...
                <td align="right" valign="top" class="normal_text_blue">News Letter Detail:</td>
             ...
             <tr>
              ...
              <tr>
				...
				<input type="button" name="cancel"  value="Cancel" class="btn" onClick="location.href='list-newsletter.php?page=<?=$page?>'">				</td>
