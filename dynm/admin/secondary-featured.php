...
if(isset($_REQUEST['submit']))
{
	...
	if(is_array($_POST['home_sec']))
	{
		$update_arr=array();
		
		foreach($_POST['home_sec'] as $home_comp)
		{
	...
	$content_arr = array();	
	$content_arr['comp_id_sec'] = $update_str ;
	$condition = " where id ='".$day."'";
	$sql->SqlUpdate('esthp_tblHomeFeat',$content_arr,$condition);
	
	echo "<body>";
	echo '<form name="frmSu" id="frmSu" method="get" action="'._ADMIN_WWWROOT.'secondary-featured.php">';
...
<script src="../wz_tooltip/wz_tooltip.js" type="text/javascript"></script>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr><td valign="top"><?php include_once('include/header.php');?><div id="breadcrumbs"> <a href="home.php">Home</a> &raquo; <a href="secondary-featured.php">Secondary Featured</a></div></td></tr>
          ...
          <tr>
            ...
            <td height="25" valign="top" class="grey_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td><h1>Secondary Featured Content</h1></td>
                  ...
                  <tr>
					...
					<table width="95%" border="0" cellspacing="0" cellpadding="5" class="border">
						...
						foreach($comp_data as $comp_rec)
						{
							...
							if(in_array($comp_rec['comp_id'], $sec_arr))
							{
								$checked='checked';
							}
						...
						?>
						<td height="30"  align="left" class="black_text"><input type="checkbox" name="home_sec[]" <?=$checked?> value="<?=$comp_rec['comp_id']?>">&nbsp;&nbsp;<?=$comp_rec['comp_name']?></td>
