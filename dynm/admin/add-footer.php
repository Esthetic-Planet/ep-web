...
if(isset($_REQUEST['Submit']) && $_REQUEST['Submit']=="Update")
	...
	{		
		...
		echo '<form name="frmSu" id="frmSu" method="post" action="'._ADMIN_WWWROOT.'add-footer.php?msg=1">';
  ...
  <tr>
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		<input type="hidden" name="title" value="Footer Content"/>
          ...
          <tr>
            ...
            <td height="25" valign="top" class="grey_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td><h1>Manage Footer Content </h1></td>
          ...
          <tr>
            ...
            <td valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="right" valign="top" class="normal_text_blue"> Footer Content:</td>
