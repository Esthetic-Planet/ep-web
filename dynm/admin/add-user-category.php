...
{	
	...
	$record_id = $sql->SqlInsert('esthp_tblUserCat',$content_arr);
	...
	if($record_id)
	{
		if($_FILES['cat_image']['name']!="")
		{
				...
				if(move_uploaded_file($_FILES['cat_image']['tmp_name'], $upload_file))
				{
					...
					$sql->SqlUpdate('esthp_tblUserCat',$content_arr,$condition);
...
if(!empty($_REQUEST['cat_id']))
{
	...
	$cat_arr = $sql->SqlSingleRecord('esthp_tblUserCat',$cond);
	$count = $cat_arr['count'];
	$Data = $cat_arr['Data'];			
}
...
if(isset($_REQUEST['act']) && $_REQUEST['act']=='delimg')
{
	...
	header("location:add-user-category.php?cat_id=".$cat_id);
}
...
<script language="javascript">
	...
	function delete_catImage()
	{
		...
		{
			window.location.href="add-user-category.php?act=delimg&cat_id=<?=$cat_id?>"; 
		}
	}
		...
		function delete_catsmallImage()
	{
		if(confirm("Are you sure to delete image?" ))
		{
			window.location.href="add-user-category.php?act=delsmallimg&cat_id=<?=$cat_id?>"; 
		}
	}
      ...
      <tr>
          ...
          <tr>
           <td height="25" valign="top" class="grey_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
               ...
               <td><h1>Add Clinic Category </h1></td>
              </tr>
            </table></td>
          </tr>
          <tr>
		  ...
		  ?>
		   ...
		   <tr>
			...
			<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td width="124" align="right" valign="top" class="normal_text_blue">Large Image :</td>
             ...
             <tr>
                ...
                <td align="left" valign="top"><input name="cat_status" type="radio" value="active" <?=($Data['cat_status']=='active' || $Data['cat_status']=='' ? 'checked' : '')?>>   <span class="normal_text_blue">Active</span>      <input name="cat_status" type="radio" value="inactive" <?=($Data['cat_status']=='inactive' ? 'checked' : '')?>>  <span class="normal_text_blue">Inactive</span></td>
				   ...
				   <tr>
					<td width="124" align="right" valign="top" class="normal_text_blue"></td>
					<td width="4" align="left" valign="top">&nbsp;</td>
					<td width="334" align="left" valign="top" class="normal_text_blue">	<input name="cat_page_url" id="chk_cat_page_url" title="Please enter category page URL." type="hidden" class="input_white" size="48" value="<?=$complete_url[0]?>" ></td>
				  </tr>
		...
		<tr>
			...
			?></td>
				...
				<input type="button" name="cancel"  value="Cancel" class="btn" onClick="location.href='list-user-categories.php'">				
