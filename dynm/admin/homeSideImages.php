...

{
			...
			$arrDest_del = $sql->SqlSingleRecord('mos_homeSideImages',$ConArr_del);
...

		{
			...
			$sql->SqlDelete('mos_homeSideImages',$cond);	

			unlink(_UPLOAD_FILE_PATH."/home_img/homeSideImages/".$Data_del['image_name']);

		echo "<body>";

		echo '<form name="frmSu" id="frmSu" method="post" action="'._ADMIN_WWWROOT.'homeSideImages.php">';
...
{		
		...
		$intResult = $sql->SqlInsert('mos_homeSideImages',$ConArr);
...

			{
				...
				// in its *temporary* location in the server (often, it is /tmp)
					...
					//$handle->image_ratio_y        = true;
						...
						$handle->Process(_UPLOAD_FILE_PATH."/home_img/homeSideImages/");
						...
						if ($handle->processed) {
							...
							$intResult = $sql->SqlUpdate('mos_homeSideImages',$ConArr,$CondArr);
					...
					$handle->image_ratio_y        = true;
						...
						if ($handle->processed) {
							...
							$intResult = $sql->SqlUpdate('mos_homeSideImages',$ConArr,$CondArr);
					 		...
					 		@unlink(_UPLOAD_FILE_PATH."/home_img/homeSideImages/".$_REQUEST['old_image_name']);
...
if(isset($_REQUEST['id']) && ($_REQUEST['mode']=='edit'))

	{
		...
		$arrBrands = $sql->SqlSingleRecord('mos_homeSideImages',$ConArr);
          ...
          <tr>
            ...
            <td height="25" valign="top" class="grey_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td><h1>Manage Homepage Top Images </h1></td>
          ...
          <tr>
            ...
            <tr>
				...
				<?php  
					...
					echo '<a href="'._WWW_UPLOAD_IMAGE_PATH.'/home_img/homeSideImages/'.$Data['image_name'].'" 	rel="facebox">
              ...
              <tr>
				...
				<input type="button" name="cancel"  value="Cancel" class="btn" onClick="location.href='homeSideImages.php?destId=<?=$destId?>'">	
          ...
          <tr>
			...
			<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center" bgcolor="#66CCFF" bordercolor="#CCCCCC">
			  ...
			  <?php 
					...
					if($count>0){
...

						{
							...
							if($Data[$i]['image_name']!="" && file_exists(_UPLOAD_FILE_PATH."/home_img/homeSideImages/".$Data[$i]['image_name']))

							{

							$img='<img src="'._WWW_UPLOAD_IMAGE_PATH.'/home_img/homeSideImages/'.$Data[$i]['image_name'].'" border="0" width="100" height="100" />';
							...
							$img='<img src="'._WWW_UPLOAD_IMAGE_PATH.'/home_img/homeSideImages/no_image_icon.jpg" border="0" width="100" height="100" />';
			  ...
			  <tr bgcolor="#FFFFFF">
				...
				<a href="homeSideImages.php?mode=edit&id=<?=$Data[$i]['id']?>"><img src="images/b_edit.png" border="0"></a>&nbsp;

				<a href="javascript: void(0)" onclick="SingleDelete('homeSideImages.php?delid=<?=$Data[$i]['id']?>&destId=<?=$destId?>');">				
