...
{		
		...
		$intResult = $sql->SqlInsert('mos_tblMainMenu',$ConArr);
	...
	{		
		...
		$intResult = $sql->SqlUpdate('mos_tblMainMenu',$ConArr,$CondArr);
...

	{
		...
		$arrBrands = $sql->SqlSingleRecord('mos_tblMainMenu',$ConArr);
