...
if($_REQUEST['delid']!="")
{
		...
		$ad_rec_arr= $sql->SqlSingleRecord('esthp_tblLeadAds',$ad_rec_cond);
		...
		if($ad_count>0)
		{
			...
			//echo "<br/>";
			$sql->SqlDelete('esthp_tblLeadAds',$delete_cond);		
...
<body>
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr><td valign="top"><?php include_once('include/header.php');?><div id="breadcrumbs"> <a href="home.php">Home</a> &raquo; <a href="leaderboard-ads.php">Leaderboard Ads</a></div></td></tr>
  <tr>
  ...
  //die;
		...
		$ad_arr = $sql->SqlRecords("esthp_tblLeadAds",$cond,$orderby,$offset,$records_per_page);
               ...
               <tr>
                ...
                <td valign="top"><table width="0%" border="0" cellspacing="0" cellpadding="0">
                 ...
                 <tr>
                   ...
                   <td width="125" align="center" valign="top"><a href="add-leaderboard.php" class="add_del">Add Leaderboard Ad</a></td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="5">
                      <tr class="left_headbg">
						...
						?>
							...
							<td align="center" class="white_text"><a href="add-leaderboard.php?ad_id=<?=$Data[$i]['ad_id']?>&page=<?=$page?>"><img src="images/edit_button.gif" alt="" width="59" height="19" border="0"></a></td>

							<td  align="center" class="white_text"><a href="javascript: void(0)" onclick="SingleDelete('leaderboard-ads.php?delid=<?=$Data[$i]['ad_id']?>&page=<?=$page?>');"><img src="images/delete_button.gif" alt="Delete" width="59" height="19" border="0"></a></td>
