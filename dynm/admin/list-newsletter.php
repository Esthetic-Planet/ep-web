...
if($_REQUEST['delid']!="")
{
	...
	$arrArticles_del = $sql->SqlSingleRecord('mos_tblnewsLetter',$ConArr_del);
	...
	{			
		...
		$cond = " ID = '".$delid."'";
		$sql->SqlDelete('mos_tblnewsLetter',$cond);				
		...
		header("location:list-newsletter.php?page=$page");
		die();
	}
}
// single Delete end
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>    <td valign="top"><?php include_once('include/header.php');?><div id="breadcrumbs"> <a href="home.php">Home</a> &raquo; <a href="list-newsletter.php">List News Letters</a></div></td>  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
          ...
          <tr>
            <td height="25" valign="top" class="grey_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td><h1>Manage News Letter </h1></td>
              </tr>
            </table></td>
          </tr>
		...
		$webPage = $sql->SqlRecords("mos_tblnewsLetter",$cond,$orderby,$offset,$records_per_page);
                  ...
                  <tr>
                    <td valign="top"><table width="0%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td align="center" valign="top"><a href="add-newsletter.php" class="add_del">Add News Letter </a></td>
                      </tr>
                    </table></td>
                  ...
                  <tr>
                    <td valign="middle" class="left_headbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="39%" class="white_text">News Letter Title </td>
                  ...
                  <tr>
					...
					if($count>0){
                      ...
                      <tr <?=($i%2==0)? 'class="grey_bg"' : ""?>>
                        ...
                        <td width="39%" class="black_text"><?=stripslashes($Data[$i]['title']);?></td>
                        <td width="15%" align="center" class="black_text"><?=$Data[$i]['status']?></td>
                        <td width="15%" align="center" class="black_text"><?=date("d/m/Y",$Data[$i]['modified_date'])?></td>
                        <td width="15%" align="center" class="white_text"><a href="add-newsletter.php?mode=edit&ID=<?=$Data[$i]['ID']?>&page=<?=$page?>">	<img src="images/edit_button.gif" alt="" width="59" height="19" border="0"></a></td>
                        <td width="12%" align="center" class="white_text"><a href="javascript: void(0)" onclick="SingleDelete('list-newsletter.php?delid=<?=$Data[$i]['ID']?>&page=<?=$page?>');"><img src="images/delete_button.gif" alt="Delete" width="59" height="19" border="0"></a></td>
                      </tr>
					  <?php 
					  		}
						}
						else	{ 	echo '<tr class="grey_bg"><td height="25" colspan="6" class="empty_record_txt">NO Record Found.</td></tr>'; 	}?>                    </table></td>
                  </tr>                  
                </table></td>
              </tr>
...
<SCRIPT type=text/javascript>
	...
	{	
		if(confirm("Are you sure you want to delete the this News Letter?"))
		{
...
function multiDelete()
{
	...
	if(checkOne)
	{
		if(confirm("Are you sure you want to delete the selected News Letter(s)?"))
		{
