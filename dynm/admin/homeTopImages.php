...

{
			...
			$arrDest_del = $sql->SqlSingleRecord('mos_homeTopImages',$ConArr_del);
...

		{
			...
			$sql->SqlDelete('mos_homeTopImages',$cond);	

			unlink(_UPLOAD_FILE_PATH."/home_img/homeTopImages/".$Data_del['image_name']);

		echo "<body>";

		echo '<form name="frmSu" id="frmSu" method="post" action="'._ADMIN_WWWROOT.'homeTopImages.php">';
...
{		
		...
		$intResult = $sql->SqlInsert('mos_homeTopImages',$ConArr);
...

			{
				...
				// in its *temporary* location in the server (often, it is /tmp)
					...
					//$handle->image_ratio_y        = true;
						...
						$handle->Process(_UPLOAD_FILE_PATH."/home_img/homeTopImages/");
						...
						if ($handle->processed) {
							...
							$intResult = $sql->SqlUpdate('mos_homeTopImages',$ConArr,$CondArr);
					...
					//$handle->image_ratio_y        = true;
						...
						if ($handle->processed) {
							...
							$intResult = $sql->SqlUpdate('mos_homeTopImages',$ConArr,$CondArr);
					 		...
					 		@unlink(_UPLOAD_FILE_PATH."/home_img/homeTopImages/".$_REQUEST['old_image_name']);
          ...
          <tr>
            ...
            <tr>
				...
				<?php  
					...
					echo '<a href="'._WWW_UPLOAD_IMAGE_PATH.'/home_img/homeTopImages/'.$Data['image_name'].'" 	rel="facebox">
              ...
              <tr>
				...
				<input type="button" name="cancel"  value="Cancel" class="btn" onClick="location.href='homeTopImages.php?destId=<?=$destId?>'">	
          ...
          <tr>
			...
			<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center" bgcolor="#66CCFF" bordercolor="#CCCCCC">
			  ...
			  <?php 
					...
					if($count>0){
...

						{
							...
							if($Data[$i]['image_name']!="" && file_exists(_UPLOAD_FILE_PATH."/home_img/homeTopImages/".$Data[$i]['image_name']))

							{

							$img='<img src="'._WWW_UPLOAD_IMAGE_PATH.'/home_img/homeTopImages/'.$Data[$i]['image_name'].'" border="0" width="100" height="100" />';
							...
							$img='<img src="'._WWW_UPLOAD_IMAGE_PATH.'/home_img/homeTopImages/no_image_icon.jpg" border="0" width="100" height="100" />';
			  ...
			  <tr bgcolor="#FFFFFF">
				...
				<a href="homeTopImages.php?mode=edit&id=<?=$Data[$i]['id']?>"><img src="images/b_edit.png" border="0"></a>&nbsp;

				<a href="javascript: void(0)" onclick="SingleDelete('homeTopImages.php?delid=<?=$Data[$i]['id']?>&destId=<?=$destId?>');">				
