...
if($_REQUEST['delid']!="")
{
	...
	$arrArticles_del = $sql->SqlSingleRecord('mos_tblWhitePaper',$ConArr_del);
	...
	{			
		...
		$cond = " ID = '".$delid."'";
		$sql->SqlDelete('mos_tblWhitePaper',$cond);				
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>    <td valign="top"><?php include_once('include/header.php');?><div id="breadcrumbs"> <a href="home.php">Home</a> &raquo; <a href="list-white-paper.php">List White Papers</a></div></td>  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
          ...
          <tr>
            <td height="25" valign="top" class="grey_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td><h1>Manage  White Paper</h1></td>
              </tr>
            </table></td>
          </tr>       
		...
		$webPage = $sql->SqlRecords("mos_tblWhitePaper",$cond,$orderby,$offset,$records_per_page);
                  ...
                  <tr>
                    <td valign="top"><table width="0%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td align="center" valign="top"><a href="add-white-paper.php" class="add_del">Add White Paper </a></td>
                      </tr>
                    </table></td>
                  ...
                  <tr>
                    <td valign="middle" class="left_headbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="39%" class="white_text"> White Paper Title </td>
                  ...
                  <tr>
					...
					if($count>0){
                      ...
                      <tr <?=($i%2==0)? 'class="grey_bg"' : ""?>>
                        ...
                        <td width="15%" align="center" class="white_text"><a href="add-white-paper.php?mode=edit&ID=<?=$Data[$i]['ID']?>&page=<?=$page?>">	<img src="images/edit_button.gif" alt="" width="59" height="19" border="0"></a></td>
                        <td width="12%" align="center" class="white_text"><a href="javascript: void(0)" onclick="SingleDelete('list-white-paper.php?delid=<?=$Data[$i]['ID']?>&page=<?=$page?>');"><img src="images/delete_button.gif" alt="Delete" width="59" height="19" border="0"></a></td>
                      </tr>
					  <?php 
					  		}
						}
...
<SCRIPT type=text/javascript>
	...
	{	
		if(confirm("Are you sure you want to delete the this White Paper?"))
		{
...
function multiDelete()
{
	...
	if(checkOne)
	{
		if(confirm("Are you sure you want to delete the selected White Paper(s)?"))
		{
