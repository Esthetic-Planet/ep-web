...
<?php header('Content-Type: text/html; charset=utf-8'); ?>
	...
	<div id="middle_area">
		...
		<div id="right_part">
			<div id="content_area">
			<div><?php if($_SESSION['welmsg']==1) { echo "<span class=\"logoutMsgBox\"> Bienvenue ".$_SESSION['UserInfo']['fname']." ".$_SESSION['UserInfo']['lname']." dans votre espace patient. Cet espace vous est d&eacute;di&eacute;. </span>";
			unset($_SESSION['welmsg']);
			}?><br /></div>
				
			<div style="float:left; width:100%" class="login_hea">
			
				<div style="float:left; width:75%" >LES SOINS</div>
				<div style="float:left;  font-size:18px; width:25%"> 
				<a   href="guideutilisateur.pdf" target="_blank"><img src="images/user_btn.jpg" /></a>
				</div>
