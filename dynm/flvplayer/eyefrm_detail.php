...
<?php include("header.php"); ?>
	...
	<div id="middle_area">
		...
		<div id="right_part">
			<div id="content_area">
				<div class="login_hea">Eye Form Listing</div>
				<div class="clear"></div>
				...
				<div id="clinic_page">
					...
					?>
						<ul>
							<li class="field1_form">
								<a href="<?=_UPLOAD_FILE_URL?>mail_attachment/<?=$doc1[$k]?>" rel="facebox"><img border='0' src='<?=_UPLOAD_FILE_URL?>mail_attachment/<?=$doc1[$k]?>' alt='Click to View' height="50" width="70"></a>
